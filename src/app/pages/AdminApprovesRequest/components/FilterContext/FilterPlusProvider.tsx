...
export const FilterPlusContext = createContext<TFilterRequestContext>({
  opened: false,
  active: 1,
  activeStatus: 1,
  isFilter: false,
...
const FilterPlusProvider = ({ children }: FilterRequestProviderProps) => {
...
export const useFilterPlusRequest = () => useContext(FilterPlusContext);
export default FilterPlusProvider;
