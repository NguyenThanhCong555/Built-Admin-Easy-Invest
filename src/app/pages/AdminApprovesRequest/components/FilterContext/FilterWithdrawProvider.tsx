...
export const FilterWithdrawContext = createContext<TFilterRequestContext>({
  opened: false,
  active: 1,
  activeStatus: 1,
  isFilter: false,
...
const FilterWithdrawProvider = ({ children }: FilterRequestProviderProps) => {
  ...
  return (
    <FilterWithdrawContext.Provider
      value={{
        opened,
        refresh,
        filterAgain,
...
export const useFilterWithdrawRequest = () => useContext(FilterWithdrawContext);
export default FilterWithdrawProvider;
