...
export const FilterDeductionContext = createContext<TFilterRequestContext>({
  opened: false,
  active: 1,
  activeStatus: 1,
  isFilter: false,
...
const FilterDeductionProvider = ({ children }: FilterRequestProviderProps) => {
  ...
  return (
    <FilterDeductionContext.Provider
      value={{
        opened,
        refresh,
        filterAgain,
...
export const useFilterDeductionRequest = () => useContext(FilterDeductionContext);
export default FilterDeductionProvider;
