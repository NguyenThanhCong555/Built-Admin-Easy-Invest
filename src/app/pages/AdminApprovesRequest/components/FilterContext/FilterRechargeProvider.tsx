...
export const FilterRequestContext = createContext<TFilterRequestContext>({
  opened: false,
  active: 1,
  activeStatus: 1,
  isFilter: false,
...
const FilterRequestProvider = ({ children }: FilterRequestProviderProps) => {
...
export const useFilterRequest = () => useContext(FilterRequestContext);
export default FilterRequestProvider;
