...
import { selectCalledDetailRequest, selectDetailRequest } from 'store/slice/request/selector';
...
export const DetailRequestWithdraw = (props: Props) => {
  ...
  return (
    <Frame onMovePage={moveToListHistory} titlePage={t('HistoryRecharge.titleDetailPage')}>
      ...
      <ModalConfirmWithdraw opened={opened} close={close} data={DataDetailRequest} isDetail={true} />
    </Frame>
  );
};
