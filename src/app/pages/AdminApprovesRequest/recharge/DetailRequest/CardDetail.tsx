  ...
  return (
    ...
    >
      <Box p={'12px 8px'}>
        <Center mb={12}>
          <Group>
            <Text className="subtitle_1-bold" c={'var(--primary-2)'}>
              +{props.status === 1 ? props.realExchange : props.usdt}
            </Text>
            <IconUsdt />
          </Group>
        </Center>
        ...
        <Group spacing={6}>
          ...
          <Stack spacing={0}>
            <Text className="body_4-bold">{props?.requesterInfo.name}</Text>
        ...
        <Group w={'100%'} noWrap spacing={10}>
          ...
          <Stack w={'100%'} spacing={2}>
            ...
            <Text className="small_4-bold">ID - {props?.accountNumber}</Text>
          </Stack>
        </Group>
