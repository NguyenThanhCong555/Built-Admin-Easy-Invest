export const images = {
  ...
  project: require('./homePage/project.svg').default,
  // LoginPage
  ...
  // fake avatar
  playTogether: require('./avatarProject/playTogether.svg').default,
  // frameimg
  frameImg: require('./frameImage/frameImage.svg').default,
